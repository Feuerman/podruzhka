$(document).ready(function () {
	...
	function tabsInit(tabs) {
		$(tabs).each(function(index, el) {
			var id = $(el).attr('data-tabs-id');
			var tabsLink = $(el).find('[data-tabs="link" data-tabs-id="' + id + '"]');
			var tabsLinkMobile = $(el).find('[data-tabs="link-mobile" data-tabs-id="' + id + '"]');
			var tabsContent = $(el).find('[data-tabs="content-item" data-tabs-id="' + id + '"]');
			...
			tabsLinkMobile.on('click', function() {
				$(this).parents('[data-tabs="content-item"]').toggleClass('active');
			});
		});
	}
