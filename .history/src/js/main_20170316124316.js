$(document).ready(function () {
	var pageHeader = $('.page-content-header');
	var pageContent = $('.page-content__right');

	$(window).on('load', function() {
		contentHeaderPosition();
	});

	function contentHeaderPosition() {
		console.log(this);
		var left = pageContent.offset().left;
		pageHeader.css('paddingLeft', left);
	}
