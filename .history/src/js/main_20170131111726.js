$(document).ready(function () {
	...
	var showActionBtn = $('.js-show-action-block');
	var actionBlock = $('.action-header');
	var timeoutHideActionBlock = setTimeout(function() {
		$(actionBlock).removeClass('active');
	}, 1500);
	$(showActionBtn, actionBlock).on({
		mouseenter: function () {
			clearTimeout(timeoutHideActionBlock);
			$(actionBlock).addClass('active');
		},
		mouseleave: function () {
			timeoutHideActionBlock();
		}
	});
