$(document).ready(function () {
	...
	actionCategorySlider.siblings('.action-category-list__slider-nav').on('click', function(e) {
		if ($(e.target).hasClass('.left')) {
			actionCategorySlider.trigger('prev.owl.carousel');
		};
		if ($(e.target).hasClass('.right')) {
			actionCategorySlider.trigger('next.owl.carousel');
		};
	});
