$(document).ready(function () {
	...
	$('.mobile-menu__link').on('click', function (e) {
		$('.mobile-menu-blocks').css('transform', 'translateX(-245px)');
		$('.mobile-menu-header__item--back-to').css('transform', 'translateX(0)');
		$('.mobile-menu-header__item--auth').css('transform', 'translateX(-245px)');
	});

	$('.mobile-menu-header__item--back-to button').on('click', function (e) {
		$('.mobile-menu-blocks').css('transform', 'translateX(0)');

		$('.mobile-menu-header__item--back-to').css('transform', 'translateX(-245px)');
		$('.mobile-menu-header__item--auth').css('transform', 'translateX(0)');
	});
