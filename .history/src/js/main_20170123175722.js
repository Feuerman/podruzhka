$(document).ready(function () {
	...
	function customPager(event) {
		...
		console.log($(this.$element[0]).parents('section'));
		$(this.$element[0]).parent('section').find('.custom-dots__current').text(item + size);
		$(this.$element[0]).parent('section').find('.custom-dots__count').text(items);
	}
